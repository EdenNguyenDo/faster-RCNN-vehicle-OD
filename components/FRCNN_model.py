...
import torchvision
from components.ROIHead import ROIHead
from components.RPN import RegionProposalNetwork
...
class FasterRCNN(nn.Module):
    ...
    def forward(self, image, target=None):
        ...
        if not self.training:
            ...
            frcnn_output['boxes'] = Helper.transform_boxes_to_original_size(frcnn_output['boxes'],
                                                                     image.shape[-2:],
                                                                     old_shape)
